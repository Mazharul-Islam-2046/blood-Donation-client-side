...
const ContactUs = () => {
  return (
    <div className="h-[50vw] max-h-[550px] bg-[url('https://c.files.bbci.co.uk/182FF/production/_107317099_blooddonor976.jpg')] bg-cover relative">
      ...
      <div className="absolute text-white top-0 w-full h-full flex justify-center items-center">
        <div className="w-4/5 h-3/5 border-8 border-red-500 text-center py-16">
          <p className="text-2xl font-semibold">Donate Now</p>
          <p className="mt-6 mb-4 text-5xl font-bold">
